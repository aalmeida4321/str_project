# 1 "mcc_generated_files/EEPROM2_app.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/EEPROM2_app.c" 2
# 22 "mcc_generated_files/EEPROM2_app.c"
...
# 22 "mcc_generated_files/EEPROM2_app.c" 2
...
# 23 "mcc_generated_files/EEPROM2_app.c" 2

# 1 "mcc_generated_files/drivers/spi_master.h" 1
# 38 "mcc_generated_files/drivers/spi_master.h"
...
# 24 "mcc_generated_files/EEPROM2_app.c" 2
...
# 25 "mcc_generated_files/EEPROM2_app.c" 2
# 34 "mcc_generated_files/EEPROM2_app.c"
...
void EEPROM2_WriteByte (uint8_t byteData, uint32_t byteAddr)
{
    ...
    spiMaster[EEPROM2].spiOpen();
                                     - no pin selected for EEPROM2_nCS


    spiMaster[EEPROM2].exchangeByte(0x02);

    spiMaster[EEPROM2].exchangeBlock(addressBuffer,3);
...
uint8_t EEPROM2_ReadByte (uint32_t address)
{
    ...
    spiMaster[EEPROM2].exchangeByte(0x03);
...
static void EEPROM2_WriteEnable(void)
{
    ...
    spiMaster[EEPROM2].exchangeByte(0x06);
...
static uint8_t EEPROM2_ReadStatusRegister(void)
{
    ...
    spiMaster[EEPROM2].exchangeByte(0x05);
