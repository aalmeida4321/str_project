...
void initializeEPROM(){
    DATAEE_WriteByte(0xAA01, 0xAA);
    DATAEE_WriteByte(0xAA01 + 1, 10);
    DATAEE_WriteByte(0xAA01 + 2, 0);
    DATAEE_WriteByte(0xAA01 + 3, 0);
    DATAEE_WriteByte(0xAA01 + 4, 0);
    DATAEE_WriteByte(0xAA01 + 5, 5);
    DATAEE_WriteByte(0xAA01 + 6, 3);
    DATAEE_WriteByte(0xAA01 + 7, 25);
    DATAEE_WriteByte(0xAA01 + 8, 2);
    DATAEE_WriteByte(0xAA01 + 9, 0);
    DATAEE_WriteByte(0xAA01 + 10, 12);
    DATAEE_WriteByte(0xAA01 + 11, 0);
    DATAEE_WriteByte(0xAA01 + 12, 0XE3);
}
...
void parseEPROMInitialization(uint8_t* magic_word,uint8_t* NREG,uint8_t* NR,uint8_t* WI,uint8_t* RI,uint8_t* PMON,uint8_t* TALA,uint8_t* ALAT,uint8_t* ALAL,uint8_t* ALAF,uint8_t* CLKH,uint8_t* CLKM,uint8_t* checksum){
    *magic_word = DATAEE_ReadByte(0xAA01);
    *NREG = DATAEE_ReadByte(0xAA01 + 1);
    *NR = DATAEE_ReadByte(0xAA01 + 2);
    *WI = DATAEE_ReadByte(0xAA01 + 3);
    *RI = DATAEE_ReadByte(0xAA01 + 4);
    *PMON = DATAEE_ReadByte(0xAA01 + 5);
    *TALA = DATAEE_ReadByte(0xAA01 + 6);
    *ALAT = DATAEE_ReadByte(0xAA01 + 7);
    *ALAL = DATAEE_ReadByte(0xAA01 + 8);
    *ALAF = DATAEE_ReadByte(0xAA01 + 9);
    *CLKH = DATAEE_ReadByte(0xAA01 + 10);
    *CLKM = DATAEE_ReadByte(0xAA01 + 11);
    *checksum = DATAEE_ReadByte(0xAA01 + 12);
}
